...
public class Provider extends ContentProvider {
    ...
    public static String AUTHORITY = "com.aware.plugin.queue_estimation.provider.queue_estimation";
    ...
    public static final class TracesCollector_Data implements BaseColumns {
        ...
        public static final Uri CONTENT_URI = Uri.parse("content://"
                + Provider.AUTHORITY + "/queue_estimation");
        public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.plugin.queue_estimation";
        public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.plugin.queue_estimation";
    ...
    public static final String DATABASE_NAME = "queue_estimation.db";

    public static final String[] DATABASE_TABLES = {"queue_estimation"};
    ...
    public boolean onCreate() {
        AUTHORITY = BuildConfig.APPLICATION_ID + ".provider.queue_estimation"; //make AUTHORITY dynamic
